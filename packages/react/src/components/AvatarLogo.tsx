    ...
    >
      <defs>
        <linearGradient id="avatar-grad" x1="24" y1="16" x2="104" y2="96">
          <stop offset="0%" stopColor="var(--ae-logo-primary)" />
          <stop offset="100%" stopColor="var(--ae-logo-secondary)" />
        </linearGradient>
      </defs>
      ...
      <path d="M41 60 Q49 51 57 60" stroke="var(--ae-logo-primary)" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M71 60 Q79 51 87 60" stroke="var(--ae-logo-primary)" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M44 74 Q64 87 84 74" stroke="var(--ae-logo-primary)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      <line x1="64" y1="42" x2="64" y2="28" stroke="url(#avatar-grad)" strokeWidth="2.5" strokeLinecap="round" />
      <circle cx="64" cy="25" r="4" fill="var(--ae-logo-primary)" />
    </svg>
  )
}
